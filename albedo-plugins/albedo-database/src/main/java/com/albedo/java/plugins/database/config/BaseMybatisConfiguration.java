...
public abstract class BaseMybatisConfiguration {
	...
	public MybatisPlusInterceptor mybatisPlusInterceptor() {
		...
		log.info("Detect the application.database.multiTenantType = {}, enabled {} mode", databaseProperties.getMultiTenantType().name(), databaseProperties.getMultiTenantType().getDescribe());
