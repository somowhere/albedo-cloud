...
@Data
@ToString
public class TableDataVo extends DataEntityVo<String> {
	...
	private TableDataVo parent;
	/*** 子表列表 */
	@JSONField(serialize = false)
	private List<TableDataVo> childList;
	...
	public TableDataVo(String name, String comments) {
		this.name = name;
	...
	public TableDataVo(TableFormVo tableFormVo) {
	...
	@JSONField(serialize = false)
	public List<TableDataVo> getChildList() {
