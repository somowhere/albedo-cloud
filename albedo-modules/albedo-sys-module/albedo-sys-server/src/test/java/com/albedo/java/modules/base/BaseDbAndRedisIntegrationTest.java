...
import com.albedo.java.common.config.datasource.AuthorityMybatisAutoConfiguration;
import com.albedo.java.plugins.cache.RedisAutoConfigure;
...
public class BaseDbAndRedisIntegrationTest {
	...
	@Import({
		...
		AuthorityDatabaseAutoConfiguration.class,
		// MyBatis 配置类
		AuthorityMybatisAutoConfiguration.class, // 自己的 MyBatis 配置类
		MybatisPlusAutoConfiguration.class, // MyBatis 的自动配置类

		// Redis 配置类
		RedisAutoConfiguration.class, // Spring Redis 自动配置类
		RedisAutoConfigure.class, // 自己的 Redis 配置类
