...
@Service
@AllArgsConstructor
public class DeptServiceImpl extends TreeCacheServiceImpl<DeptRepository, DeptDo, DeptDto> implements DeptService {
	...
	private void checkDept(Long deptId, String deptName) {
		...
		if (CollUtil.isNotEmpty(roleList)) {
			throw new BizException("操作失败！角色：" + CollUtil.convertToString(roleList, RoleDo.F_NAME, StringUtil.COMMA)
