...
@Service
@AllArgsConstructor
public class MenuServiceImpl extends TreeCacheServiceImpl<MenuRepository, MenuDo, MenuDto> implements MenuService {
	...
	public boolean saveByGenScheme(GenSchemeDto schemeDto) {
		...
		Assert.isTrue(parentMenuDo != null, StringUtil.toAppendStr("根据模块id[", parentMenuId, "无法查询到模块信息]"));
