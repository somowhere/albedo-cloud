...
public class LogLoginResource extends BaseResource {
	...
	public Result<IPage> innerSave(@Valid @RequestBody LogLoginDo logLoginDo) {
		return Result.buildOkData(service.save(logLoginDo));
	}
	...
	@PreAuthorize("@pms.hasPermission('sys_logLogin_export')")
