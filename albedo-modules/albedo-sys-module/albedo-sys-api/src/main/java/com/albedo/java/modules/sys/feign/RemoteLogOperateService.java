 ...
 * @date 2019/2/1
 */
@FeignClient(contextId = "remoteLogOperateService", value = ServiceNameConstants.SYS_SERVICE,
...
public interface RemoteLogOperateService {
	 ...
	 * @return succes、false
	 */
	@PostMapping("/log-operate/inner/save")
	Result<Boolean> save(@RequestBody LogOperateDo logOperateDo, @RequestHeader(SecurityConstants.FROM) String from);
}
