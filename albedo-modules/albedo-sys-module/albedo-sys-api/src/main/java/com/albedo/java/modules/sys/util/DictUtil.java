...
public class DictUtil {
	...
	public static List<DictDo> getDictList() {
		return cacheOps.get(new DictCacheKeyBuilder().key(CacheNameConstants.DICT_ALL), (k) -> JSONUtil.toList(dictService.findAllOrderBySort(SecurityConstants.FROM_IN).getData(), DictDo.class));
	}
