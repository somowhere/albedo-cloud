...
@AllArgsConstructor
public class TenantDo extends IdDo<TenantDo, Long> {
	...
	@Builder
	public TenantDo(Long id, LocalDateTime createdDate, Long createdBy, LocalDateTime lastModifiedDate, Long lastModifiedBy,
