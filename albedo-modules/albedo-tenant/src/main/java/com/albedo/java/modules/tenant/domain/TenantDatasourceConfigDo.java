...
@AllArgsConstructor
public class TenantDatasourceConfigDo extends BaseDo<TenantDatasourceConfigDo> {
	...
	@Builder
	public TenantDatasourceConfigDo(Long id, LocalDateTime createdDate, Long createdBy,
