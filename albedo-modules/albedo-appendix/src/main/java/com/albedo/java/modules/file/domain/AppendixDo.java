...
public class AppendixDo extends IdDo<AppendixDo, Long> {
	...
	@Builder
	public AppendixDo(Long id, LocalDateTime createdDate, Long createdBy, LocalDateTime lastModifiedDate, Long lastModifiedBy,
