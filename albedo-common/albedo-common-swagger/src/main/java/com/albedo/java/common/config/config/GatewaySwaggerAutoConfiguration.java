...
import com.albedo.java.common.config.support.*;
...
public class GatewaySwaggerAutoConfiguration {
	...
	@Bean
	public SwaggerProvider swaggerProvider(ApplicationSwaggerProperties swaggerProperties, GatewayProperties gatewayProperties) {
	...
	public SwaggerBasicGatewayFilter swaggerBasicGatewayFilter(ApplicationSwaggerProperties swaggerProperties) {
	...
	@Bean
	public RouterFunction<ServerResponse> swaggerRouterFunction(ApplicationSwaggerProperties swaggerProperties,
