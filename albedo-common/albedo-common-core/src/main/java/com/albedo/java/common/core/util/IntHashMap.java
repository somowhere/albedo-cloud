 ...
 *
 * <p>
 * Note that this class is for internal optimization purposes only, and may not be
 * supported in future releases of Apache Commons Lang. Utilities of this sort may be
 * included in future releases of Apache Commons Collections.
 * </p>
 *
...
class IntHashMap {
	 ...
	 * <code>20</code> and <code>0.75</code> respectively.
	 * </p>
	 */
	public IntHashMap() {
		this(20, 0.75f);
	...
	/**
	 * <p>
	 * Tests if some key maps into the specified value in this hashtable. This operation
	 * is more expensive than the <code>containsKey</code> method.
	 * </p>
	 *
	 * <p>
	 * Note that this method is identical in functionality to containsValue, (which is
	 * part of the Map interface in the collections framework).
	 * </p>
	 *
	 * @param value a value to search for.
	 * @return <code>true</code> if and only if some key maps to the <code>value</code>
	 * argument in this hashtable as determined by the <tt>equals</tt> method;
	 * <code>false</code> otherwise.
	 ...
	 *
	 * <p>
	 * Note that this method is identical in functionality to contains (which predates the
	 * Map interface).
	 * </p>
	 *
	 ...
	 * @return <code>true</code> if and only if the specified object is a key in this
	 * hashtable, as determined by the <tt>equals</tt> method; <code>false</code>
	 * otherwise.
	 * @see #contains(Object)
	 */
	 ...
	 * @return the value to which the key is mapped in this hashtable; <code>null</code>
	...
	/**
	 * <p>
	 * Maps the specified <code>key</code> to the specified <code>value</code> in this
	 * hashtable. The key cannot be <code>null</code>.
	 * </p>
	 *
	 * <p>
