...
package com.albedo.java.common.feign.sentinel.ext;
 ...
 */
@Slf4j
public class AlbedoSentinelInvocationHandler implements InvocationHandler {
	...
	AlbedoSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			AlbedoSentinelInvocationHandler other = (AlbedoSentinelInvocationHandler) obj;
