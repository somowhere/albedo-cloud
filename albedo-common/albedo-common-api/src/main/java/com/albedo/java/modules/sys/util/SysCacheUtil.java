...
public class SysCacheUtil {
	...
	public static RemoteUserService userService = SpringContextHolder.getBean(RemoteUserService.class);
	public static RemoteRoleService roleService = SpringContextHolder.getBean(RemoteRoleService.class);
