package com.albedo.java.common.security.grant;

import com.albedo.java.common.security.service.UserDetailsServiceImpl;
...
public class CustomAppAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		UserDetails userDetails = ((UserDetailsServiceImpl) userDetailsService).loadUserByPhone(phone);
