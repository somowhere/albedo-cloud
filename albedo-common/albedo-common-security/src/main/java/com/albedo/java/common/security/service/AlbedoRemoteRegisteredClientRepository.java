...
public class AlbedoRemoteRegisteredClientRepository implements RegisteredClientRepository {
	...
	public RegisteredClient findByClientId(String clientId) {
		Result<OauthClientDetailDo> detailsR = clientDetailService.getClientDetailsById(clientId,
			SecurityConstants.FROM_IN);
		OauthClientDetailDo clientDetails = detailsR.getData();
