...
public final class AlbedoSentinelFeign {
	...
	private AlbedoSentinelFeign() {

	}

	public static AlbedoSentinelFeign.Builder builder() {
		return new AlbedoSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public AlbedoSentinelFeign.Builder contract(Contract contract) {
