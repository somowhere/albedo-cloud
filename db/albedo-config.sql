...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='config_info';
...
INSERT INTO `config_info` VALUES (34, 'albedo-xxl-job-dev.yml', 'DEFAULT_GROUP', '# 数据源\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    druid:\n      driver-class-name: com.mysql.cj.jdbc.Driver\n      username: root\n      password: 111111\n      url: jdbc:mysql://albedo-mysql:3306/albedo-job?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowMultiQueries=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Asia/Shanghai\n\nxxl:\n  job:\n    admin:\n      addresses: http://albedo-xxl-job-admin:8080/xxl-job-admin', 'ba2c626955975a7b69c06380fe618a5d', '2020-09-19 16:36:36', '2020-09-19 16:36:36', NULL, '127.0.0.1', '', '', '分布式调度', NULL, NULL, 'yaml', NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='多租户改造';
