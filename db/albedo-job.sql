/*
 ...
 Date: 05/04/2021 09:58:17
*/
DROP
DATABASE IF EXISTS `albedo-job`;

CREATE
DATABASE  `albedo-job` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
VALUES (1, 'xxl-job-executor-sample', '示例执行器', 0, NULL, '2021-04-05 09:58:05');
