...
-- ----------------------------
BEGIN;
INSERT INTO `qrtz_scheduler_state` VALUES ('AlbedoScheduler', 'somewheredembp.lan1600582391138', 1600584129961, 15000);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `qrtz_triggers` VALUES ('AlbedoScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1600582400000, -1, 5, 'PAUSED', 'CRON', 1600582393000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('AlbedoScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1600582395000, -1, 5, 'PAUSED', 'CRON', 1600582393000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('AlbedoScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1600582400000, -1, 5, 'PAUSED', 'CRON', 1600582393000, 0, NULL, 2, '');
COMMIT;
