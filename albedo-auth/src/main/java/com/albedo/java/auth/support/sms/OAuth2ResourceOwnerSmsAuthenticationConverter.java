package com.albedo.java.auth.support.sms;

import com.albedo.java.auth.support.base.OAuth2ResourceOwnerBaseAuthenticationConverter;
...
public class OAuth2ResourceOwnerSmsAuthenticationConverter
	...
	public OAuth2ResourceOwnerSmsAuthenticationToken buildToken(Authentication clientPrincipal, Set requestedScopes,
		...
		return new OAuth2ResourceOwnerSmsAuthenticationToken(new AuthorizationGrantType(ApplicationAppTypeEnum.APP.getCode()),
