...
import com.albedo.java.auth.support.CustomeOAuth2AccessTokenGenerator;
import com.albedo.java.auth.support.core.AlbedoDaoAuthenticationProvider;
import com.albedo.java.auth.support.core.CustomeOAuth2TokenCustomizer;
import com.albedo.java.auth.support.core.FormIdentityLoginConfigurer;
import com.albedo.java.auth.support.handler.AlbedoAuthenticationFailureEventHandler;
import com.albedo.java.auth.support.handler.AlbedoAuthenticationSuccessEventHandler;
import com.albedo.java.auth.support.password.OAuth2ResourceOwnerPasswordAuthenticationConverter;
import com.albedo.java.auth.support.password.OAuth2ResourceOwnerPasswordAuthenticationProvider;
import com.albedo.java.auth.support.sms.OAuth2ResourceOwnerSmsAuthenticationConverter;
import com.albedo.java.auth.support.sms.OAuth2ResourceOwnerSmsAuthenticationProvider;
