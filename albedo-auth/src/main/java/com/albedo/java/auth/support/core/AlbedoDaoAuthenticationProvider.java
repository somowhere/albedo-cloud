 ...
 * @date 2022-06-04
 */
public class AlbedoDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public AlbedoDaoAuthenticationProvider() {
	...
	protected void additionalAuthenticationChecks(UserDetails userDetails,
		...
		if (StrUtil.equals(ApplicationAppTypeEnum.APP.getCode(), grantType)) {
			return;
		}
	...
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
		...
		HttpServletRequest request = WebUtil.getRequest().orElseThrow(
