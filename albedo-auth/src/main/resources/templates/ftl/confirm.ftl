  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
      <p class="navbar-text navbar-right">
        <a target="_blank" href="https://github.com/somowhere">技术支持</a>
      </p>
      <p class="navbar-text navbar-right">
        <a target="_blank" href="https://github.com/somowhere">${user.username}</a>
      </p>
    </div>
  </div>
</nav>
...
<footer>
  <p>support by: somewhere</p>
  <p>email: <a href="mailto:wangiegie@gmail.com">somewhere0813@gmail.com</a>.</p>
</footer>
</body>
</html>
