...
<head>
	<meta charset="UTF-8"/>
	<meta name="viewport"
	      content="width=device-width,initial-scale=1,minimum-scale=1,maximum-scale=1,userDo-scalable=no"/>
	<title>Albedo 第三方授权</title>
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
			<p class="navbar-text navbar-right">
				<a target="_blank" href="https://github.com/somowhere/albedo">技术支持</a>
			</p>
			<p class="navbar-text navbar-right">
                <#if principalName=="anonymousUser">
					未登录
                <#else>
					<a target="_blank" href="https://github.com/somowhere/albedo">${principalName}</a>
                </#if>
			</p>
		</div>
	</div>
